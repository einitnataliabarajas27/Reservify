      ...
      <div className="w-full max-w-max">
        ...
        <div className="flex justify-center items-center space-x-4 h-full grid-cols-2">
          <Card
            ...
            } shadow-xl w-[23rem] border-0 bg-white/80 backdrop-blur-sm`}
          >
            ...
            <CardContent className="space-y-6">
              <form className="space-y-4">
                ...
                <Button
                  type="button"
                  onClick={() => setShowCard(false)} // Solo cambia la tarjeta
                  className="w-full h-11 bg-gradient-to-r from-blue-600 to-gray-600 ..."
                >
<<<<<<< HEAD
                  {isLoading ? (
...
<<<<<<< HEAD
                  <span className="h-6 bg-white-600 hover:to-gray-100 text-gray-700 font-medium transition-all duration-200 transform hover:scale-[1.02]">Google</span>
=======
...
>>>>>>> main
        ...
        <div className="justify-center items-center h-full">
          <Card
            ...
            } shadow-xl w-full border-0 bg-white/80 backdrop-blur-sm`}
          >
            <CardHeader
